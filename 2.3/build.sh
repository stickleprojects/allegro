...
g++ -g -Iinclude -o $1 $1.cpp include/SimpleAnimationFrame.cpp include/AnimatedSprite.cpp include/ResourceManager.cpp include/Sprite.cpp include/BitmapResource.cpp `pkg-config --cflags --libs allegro-5 allegro_font-5 allegro_main-5 allegro_image-5 allegro_primitives-5`
